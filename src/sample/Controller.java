 ...
 Model ourModel;
   ...
   public void initialize() {
       ...
       CBY.setOnAction(e-> {
                   ...
                   if (CBY.valueProperty().get().equals("1996")) {
                       System.out.println("1996 action happened");
                   }
           if (CBY.valueProperty().get().equals("1997")) {
               System.out.println("1997 action happened");

           }
           if (CBY.valueProperty().get().equals("1998")) {
               System.out.println("1998 action happened");

           }
           if (CBY.valueProperty().get().equals("1999")) {
               System.out.println("1999 action happened");

           }
           if (CBY.valueProperty().get().equals("2000")) {
               System.out.println("2000 action happened");

           }
           if (CBY.valueProperty().get().equals("2001")) {
               System.out.println("2001 action happened");

           }
           if (CBY.valueProperty().get().equals("2002")) {
               System.out.println("2002 action happened");

           }
           if (CBY.valueProperty().get().equals("2003")) {
               System.out.println("2003 action happened");

           }
           if (CBY.valueProperty().get().equals("2004")) {
               System.out.println("2004 action happened");

           }
           if (CBY.valueProperty().get().equals("2005")) {
               System.out.println("1996 action happened");

           }if (CBY.valueProperty().get().equals("2006")) {
               System.out.println("1996 action happened");

           }if (CBY.valueProperty().get().equals("2007")) {
               System.out.println("1996 action happened");

           }if (CBY.valueProperty().get().equals("2008")) {
               System.out.println("1996 action happened");

           }if (CBY.valueProperty().get().equals("2009")) {
               System.out.println("1996 action happened");

           }if (CBY.valueProperty().get().equals("2010")) {
               System.out.println("1996 action happened");

           }if (CBY.valueProperty().get().equals("2011")) {
               System.out.println("1996 action happened");
